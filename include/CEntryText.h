...
#ifndef _CENTRYPANEL_H_
#define _CENTRYPANEL_H_
...
class CEntryText : public wxTextCtrl
{
	public:
		CEntryText(wxWindow * parent, int id);
		~CEntryText();
	
	private:
		wxArrayString   m_entryhistory;
		int             m_historyindex;
