...
class WXDLLIMPEXP_HTML CHtmlDCRenderer : public wxObject
{
public:
    CHtmlDCRenderer();
    ~CHtmlDCRenderer();
...
private:
    ...
    wxFileSystem *m_FS;
    CHtmlContainerCell *m_Cells;
    int m_MaxWidth, m_Width, m_Height;

    DECLARE_NO_COPY_CLASS(CHtmlDCRenderer)
};
...
class WXDLLIMPEXP_HTML CHtmlPrintout : public wxPrintout
{
public:
    CHtmlPrintout(const wxString& title = wxT("Printout"));
    ~CHtmlPrintout();
...
class WXDLLIMPEXP_HTML CHtmlEasyPrinting : public wxObject
{
public:
    CHtmlEasyPrinting(const wxString& name = wxT("Printing"), wxWindow *parentWindow = NULL);
    ~CHtmlEasyPrinting();
...
protected:
    virtual CHtmlPrintout *CreatePrintout();
    virtual bool DoPreview(CHtmlPrintout *printout1, CHtmlPrintout *printout2);
    virtual bool DoPrint(CHtmlPrintout *printout);
...
private:
    ...
    DECLARE_NO_COPY_CLASS(CHtmlEasyPrinting)
};
