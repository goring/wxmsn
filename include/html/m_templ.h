...
#define TAG_HANDLER_BEGIN(name,tags)                                      \
    class wxHTML_Handler_##name : public CHtmlWinTagHandler              \
    {                                                                     \
        public:                                                           \
...
#define TAG_HANDLER_CONSTR(name)                                                \
        public:                                                           \
        wxHTML_Handler_##name () : CHtmlWinTagHandler()


#define TAG_HANDLER_PROC(varib)                                           \
        public:                                                           \
            bool HandleTag(const CHtmlTag& varib)
...
#define TAGS_MODULE_BEGIN(name)                                           \
    class wxHTML_Module##name : public CHtmlTagsModule                   \
    {                                                                     \
        DECLARE_DYNAMIC_CLASS(wxHTML_Module##name )                       \
        public:                                                           \
            void FillHandlersTable(CHtmlWinParser *parser)               \
                {
...
#define TAGS_MODULE_END(name)                                             \
    ...
    IMPLEMENT_DYNAMIC_CLASS(wxHTML_Module##name , CHtmlTagsModule)
